...
os.environ.setdefault(
    "DATABASE_URL",
    (
        "postgresql://neondb_owner:npg_fLhUtF8BTxj0@ep-rough-haze-agen0oah.c-2.eu-central-1."
        "aws.neon.tech/silo_sling_droop_971937"
    )
)
os.environ.setdefault(
...
os.environ.setdefault('EMAIL_HOST_PASS', 'ulxy bwpl fyse samp')
